    ...
    if (lang === 'mr') {
      return [
        ...
        },
        {
          ...
          a: 'आम्ही शुद्ध साजुक तूप, उत्कृष्ट दुहेरी फिल्टर केलेले तेल वापरतो आणि कोणतेही केमिकल प्रिझर्व्हेटिव्ह घालत नाही. चिवडा ४ ते ६ आठवडे आणि शंकरपाळे ३ ते ४ आठवडे हवाबंद डब्यात कोरड्या ठिकाणी ठेवल्यास उत्तम टिकतात.'
        }
      ];
    } else if (lang === 'hi') {
      return [
        ...
        },
        {
          ...
          a: 'चूंकि हम प्रीमियम डबल-फिल्टर्ड तेल, शुद्ध घी का उपयोग करते हैं और कोई रसायन नहीं मिलाते हैं, इसलिए पोहा चिवड़ा 4-6 सप्ताह तक और शंकरपाली 3-4 सप्ताह तक एयरटाइट कंटेनर में बिल्कुल कुरकुरे रहते हैं।'
        }
      ];
    } else {
      return FAQS;
